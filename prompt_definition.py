...
# Prompt definition for the assistant with detailed instructions on how to process the queries
prompt_definition = """
...
# Simplified prompt definition focusing on nursing procedures
...
# Expanded prompt definition including additional fields like risks and observations
...
# Latest prompt definition ensuring strict adherence to document information and JSON response format
...
# Set the active prompt definition
